#!/usr/bin/env python
""" Runs dice_scrape.py testnonexistent.html test, capturing output.
    makecomparenonexistent.py rev 2013 June 23, by Stuart Ambler.
    Copyright (c) 2013 Stuart Ambler.
    Distributed under the Boost License in the accompanying file LICENSE.
    Usage:  ./makecomparenonexistent.py [all_fields]
